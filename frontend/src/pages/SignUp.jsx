    ...
    return (
        <div className='min-h-screen w-full flex items-center justify-center p-4' style={{ backgroundColor: bgColor }}>
            <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px] `} style={{
                ...
                <h1 className={`text-3xl font-bold mb-2 `} style={{ color: primaryColor }}>Men On Rent</h1>
                <p className='text-gray-600 mb-8'>Create your account to book trusted local workers, or sign up as a worker to start earning
                </p>
                ...
                <div className='mb-4'>
                    ...
                    <div className='flex gap-2'>
                        {[{ value: "customer", label: "Customer" }, { value: "worker", label: "Worker" }].map(({ value, label }) => (
                            <button
                                key={value}
